...
export default function ContactInfo({contactInfo}: Props) {
  return (
    ...
    <Text as="h5" className='text-black-text-100 capitalize tracking-[-1.639px] font-bold leading-normal mb-4 text-2xl sm:text-4xl md:text-[54px] xl:text-[64px] 2xl:text-[74px] 4xl:text-[86px] 2xl:leading-21.5 2xl:mb-9.75'>Talk to Us.</Text>
