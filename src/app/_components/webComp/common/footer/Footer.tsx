    ...
    <footer className="bg-mid pt-10 md:pt-15 xl:pt-20 2xl:pt-31.5">
      <div className="max-w-300 mx-auto px-4 lg:px-6">
        ...
        <div className="flex flex-row flex-wrap justify-between gap-2 text-white mt-8 mb-8 lg:mb-25 lg:mt-15">
          ...
          <hr className="h-77.5 w-px bg-grey-bg-50 self-center text-grey-bg-50 hidden lg:block"></hr>
          <div className="w-full lg:w-44 xl:w-43">
            ...
            <Links links={navigation} className="flex flex-col gap-3.5" linkClassName="font-light font-light text-sm md:text-base xl:text-lg capitalize text-(--text-grey-50)" />
          </div>
          <div className="w-full lg:w-90 xl:w-95">
            ...
            <Links info={contactInfo} className="flex flex-col gap-4.5"  linkClassName="flex items-center flex-wrap gap-2 lg:gap-[17px] font-light text-sm md:text-base xl:text-lg" iconClassName="bg-white text-black w-8 h-8 xl:w-13 xl:h-13 flex items-center justify-center rounded-full text-lg xl:text-2xl"/>
          </div>
        </div>
