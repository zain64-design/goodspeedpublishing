                    ...
                    <SwiperSlide key={id}>
                        <div className="transition-all duration-200 ease-in-out item-main scale-[.7] pt-12 sm:pt-22">
                            ...
                            <div className="overlay-shadow relative rotate-20 -translate-x-5.5">
                                <ImageComp src={img} width={370} height={585} alt="Before" className="w-auto max-h-110 lg:max-h-146.25 mx-auto object-contain object-center drop-shadow-[5px_8px_5px_rgba(0,0,0,0.30)]" />
                            </div>
                        </div>
