                    ...
                    <SwiperSlide key={id}>
                        <div className="transition-transform duration-500 ease-in-out item-main scale-[.7] pt-12 sm:pt-22">
                            ...
                            <div className="overlay-shadow relative rotate-20">
                                <ImageComp src={img} width={370} height={585} loading='eager' sizes="(max-width: 991px) 33vw, 250px" alt="portfolio book" className="max-w-auto max-h-110 lg:max-h-146.25 mx-auto object-contain object-center drop-shadow-[5px_8px_5px_rgba(0,0,0,0.30)]" />
                            </div>
                        </div>
