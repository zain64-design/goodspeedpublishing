              ...
              <SwiperSlide key={id}>
                <div className="items-center md:pt-15 lg:pt-20 xl:pt-23.25">
                  <div className="text-center">
                    ...
                    <ImageComp src={img} width={665} height={430} sizes="(max-width: 767px) 100vw, 50vw" alt="story book" className="w-full max-h-166.25 h-auto mx-auto object-contain object-center" />
                  </div>
                </div>
              </SwiperSlide>
            ))}
