        ...
        <div className="banner-box bg-primary py-4 px-6 md:py-4 md:px-6 lg:py-5 lg:px-9 2xl:py-6 2xl:px-11 4xl:py-8 4xl:px-13 6xl:py-9.75 6xl:px-15 rounded-[30px] lg:rounded-[48px] bg-no-repeat bg-bottom-right bg-size-[140px_155px] md:bg-size-[160px_177px] 2xl:bg-size-[290px_320px] 4xl:bg-size-[345px_381px] overflow-hidden" style={{
            ...
            <div className="w-full sm:w-[calc(100%-20%)] xl:w-[calc(100%-20%)] 2xl:w-[calc(100%-30%)] 4xl:w-[calc(100%-35%)]">
                <div className="flex flex-row flex-wrap items-center gap-2 mb-4 sm:mb-5 md:mb-6 lg:mb-8 2xl:gap-4 xl:mb-13.25">
                    <ImageComp src={LeftBoxBook} width={216} height={77} quality={25} preload  sizes="(max-width: 767px) 120px, (max-width: 1199px) 140px, (max-width: 1399px) 200px, 216px" className="max-w-30 md:max-w-35 xl:max-w-50 2xl:max-w-54 block object-contain" alt="element-books" />
                    <Text as="p" className="text-mid font-extrabold text-xl lg:text-2xl xl:text-4xl 4xl:text-[40px] text-left capitalize flex flex-row items-baseline-last max-w-42.5 gap-2.5">
                        2k+
